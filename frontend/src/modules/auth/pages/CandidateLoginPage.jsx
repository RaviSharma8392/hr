...
import { loginWithEmail, loginWithGoogle } from "../";
import {
  Briefcase,
  AlertCircle,
  Loader2,
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center px-4 sm:px-12 py-8 relative pb-safe">
        ...
        <div className="w-full max-w-[440px] mt-12 lg:mt-0 bg-white md:bg-transparent lg:bg-white md:rounded-2xl lg:rounded-none md:border lg:border-none border-[#EEE] md:shadow-[0_8px_40px_rgba(0,0,0,0.04)] lg:shadow-none p-4 sm:p-10 lg:p-0">
          ...
          <div className="mt-8 pt-6 border-t border-[#EEE]">
            <p className="text-center text-[14px] font-medium text-gray-500 mb-3">
              New to HRMastery?{" "}
              <Link
                to="/candidate/signup"
            ...
            {/* HR / Employer Redirect */}
            <div className="bg-[#F8F9FA] rounded-lg p-4 flex flex-col sm:flex-row items-center justify-between gap-3 mt-4 border border-[#EEE]">
              <div className="flex items-center gap-3">
              ...
              <Link
                to="/hr/login"
                className="whitespace-nowrap px-4 py-2 bg-white border border-[#DDD] text-[13px] font-bold text-[#484848] rounded-md hover:text-orange-600 hover:border-orange-500 transition-colors shadow-sm">
                Employer Login
              </Link>
            </div>
          </div>
